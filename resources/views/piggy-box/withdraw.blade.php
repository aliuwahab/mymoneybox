<x-layouts.app>
    @php
        ...
        $feePercent = $piggyBox->getEffectiveFeePercentage();
    ...
    <div class="page-wrap max-w-[720px] mx-auto w-full">
        ...
        {{-- Back --}}
        <div class="mb-6">
            <a href="{{ route('piggy.my-piggy-box') }}"
            ...
            <div class="card-body">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="tiny">From: {{ $piggyBox->title }}</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <form
                    action="{{ route('piggy.withdraw.store') }}"
                    method="POST"
                    class="space-y-5"
                    x-data="{
                        amount: '{{ old('amount', '') }}',
                ...
                >
                    ...
                    <div class="flex items-center gap-2.5 pt-1">
                        ...
                        <a href="{{ route('piggy.my-piggy-box') }}" class="btn" wire:navigate>
                            Cancel
                        </a>
                    </div>
                </form>
