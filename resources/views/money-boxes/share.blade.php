                    ...
                    <div class="flex flex-col items-center">
                        @if($moneyBox->hasQrCode())
                            <img
                                ...
                                alt="QR Code for {{ $moneyBox->title }}"
                            ...
                            <div class="mt-4 flex flex-col sm:flex-row gap-2 w-full max-w-md">
                                <a
                                    ...
                                    class="flex-1 flex items-center justify-center space-x-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-sm transition"
                                >
                                ...
                                <a
                                    href="https://wa.me/?text={{ urlencode($moneyBox->title . "\n\nScan this QR code or visit: " . route('box.show', $moneyBox->slug)) }}"
                                    target="_blank"
                                    class="flex-1 flex items-center justify-center space-x-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg shadow-sm transition"
                                >
                            ...
                            <p class="text-xs text-gray-500 mt-3 text-center">
                                Download and share this QR code. Anyone who scans it can contribute to your money box.
                            </p>
                        @else
