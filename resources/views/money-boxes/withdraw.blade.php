<x-layouts.app>
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Back Button -->
            <div class="mb-6">
                <a href="{{ route('money-boxes.show', $moneyBox) }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
            ...
            <div class="bg-white rounded-lg shadow mb-6 p-6">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">From: {{ $moneyBox->title }}</p>
                    </div>
                </div>
                ...
                <div class="bg-green-50 border-2 border-green-200 rounded-lg p-4">
                    ...
                    <div class="text-3xl font-bold text-green-600">
                        {{ $moneyBox->formatAmount($availableBalance) }}
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <form action="{{ route('money-boxes.withdraw.store', $moneyBox) }}" method="POST">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                ...
                                Maximum: {{ $moneyBox->formatAmount($availableBalance) }}
                            </p>
                            @error('amount')
