            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white">
                    <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                        Collect Contributions <span class="text-primary-200">Made Easy</span>
                    </h1>
                    <p class="text-xl md:text-2xl mb-8 text-primary-100">
                        Create a money box for any occasion. Share with friends and family. Track contributions in real-time.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="{{ route('register') }}" class="px-8 py-4 bg-white text-primary-700 font-bold rounded-lg hover:bg-primary-50 transition text-center shadow-lg">
                            Create Your Money Box
                        </a>
                        <a href="{{ route('browse') }}" class="px-8 py-4 bg-primary-500/20 backdrop-blur-sm text-white font-bold rounded-lg hover:bg-primary-500/30 transition text-center border-2 border-white/30">
                            Browse Money Boxes
                        </a>
                    </div>
                    ...
                    <div class="mt-12 grid grid-cols-3 gap-8">
                        <div>
                            ...
                            <div class="text-primary-200">Money Boxes</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-white">{{ \App\Models\Contribution::count() }}+</div>
                            <div class="text-primary-200">Contributions</div>
                        </div>
                        <div>
                ...
                <div class="relative">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-lg">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-3">
                                    <div class="bg-gradient-to-r from-primary-500 to-primary-600 h-3 rounded-full" style="width: 75%"></div>
                                </div>
                            </div>
                    ...
                    <!-- Decorative Elements -->
                    <div class="absolute -top-4 -right-4 w-24 h-24 bg-primary-400 rounded-full blur-3xl opacity-50"></div>
                    <div class="absolute -bottom-4 -left-4 w-32 h-32 bg-primary-300 rounded-full blur-3xl opacity-50"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="featured" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-12">
                ...
                <a href="{{ route('browse') }}" class="text-primary-600 hover:text-primary-700 font-semibold flex items-center">
                    View All
            ...
            @else
                <div class="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700">
                            Create Money Box
                        </a>
                    </div>
                </div>
