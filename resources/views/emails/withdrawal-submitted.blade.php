...
<style>
  ...
  .info-box { background: #F3F1EB; border: 1px solid #E6E3DC; border-radius: 8px; padding: 14px 16px; margin-bottom: 24px; }
  .info-box p { font-size: 13px; color: #6B6862; margin: 0; line-height: 1.5; }
